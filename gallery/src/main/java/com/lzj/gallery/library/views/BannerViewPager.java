...
//    };
     ...
     */
    public BannerViewPager initBanner(List<String> list,boolean isGallery,boolean isTitle){
        mList=list;
        //引入布局
        ...
        mPagerAdapter = new BannerPagerAdapter(mList,mContext,isTitle);
     ...
     * @param alpha  滑动透明度变化
     */
    public BannerViewPager initBanner(List<String> list,boolean isGallery,float alpha,boolean isTitle){
        mList=list;
     ...
     * @param distance 间距
     */
    public BannerViewPager hideIndicator() {

        if (mLineIndicator!=null){
            mLineIndicator.setVisibility(GONE);
        }
