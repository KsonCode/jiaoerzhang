package com.jiaoerzhang.platform.lib_net.network.rx;
...
public class RxManager {
    ...
    public void on(String eventName, MyConsumer<Object> consumer) {
        // 注册
        ...
        mCompositeSubscription
                .add(mObservable.observeOn(AndroidSchedulers.mainThread())
                        .subscribe(consumer.setTag(eventName), new Consumer<Throwable>() {
                            @Override
