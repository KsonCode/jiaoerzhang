...
import com.jiaoerzhang.platform.lib_net.ApiService;
import com.jiaoerzhang.platform.lib_net.network.BaseObserver;
import com.jiaoerzhang.platform.lib_net.network.RetrofitHelper;
import com.jiaoerzhang.platform.lib_net.network.rx.HttpResultFunc;
import com.jiaoerzhang.platform.lib_net.network.rx.RxManager;
import com.jiaoerzhang.platform.lib_net.network.rx.RxSchedulers;
import com.jiaoerzhang.platform.lib_net.utils.EncryBody;
import com.jiaoerzhang.platform.lib_net.utils.KeyHelper;
...
//                .addHeaderParams("Content-Type", "application/x-www-form-urlencoded")
    ...
    @Override
    public void jsonPostData(String url, HashMap<String,String> params,String body,final ICallback callback) {

        apiService.jsonPostData(url,params, body)
                .map(new HttpResultFunc())
                .compose(RxSchedulers.<String>io_main())
                .subscribe(new BaseObserver<String>() {
    ...
    @Override
    public void jsonPostData(String url, String body, HashMap<String, String> params, final ICallback callback) {
        apiService.jsonPostData(url, body,params)
                .map(new HttpResultFunc())
                .compose(RxSchedulers.<String>io_main())
                .subscribe(new BaseObserver<String>() {
