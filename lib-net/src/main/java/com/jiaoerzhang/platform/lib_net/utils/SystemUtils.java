package com.jiaoerzhang.platform.lib_net.utils;
...
public class SystemUtils {
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) NetApp.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE);
