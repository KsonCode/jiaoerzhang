package com.jiaoerzhang.platform.lib_net;
...
public interface ApiService {
    ...
    Observable<Response<String>> jsonPostData(@Url String url,@QueryMap HashMap<String,String> params,@Body String body);

    @POST
    @Headers({"Content-Type: application/json","Accept: application/json"})
    Observable<Response<String>> jsonPostData(@Url String url,@Body String body,@FieldMap HashMap<String,String> params);
