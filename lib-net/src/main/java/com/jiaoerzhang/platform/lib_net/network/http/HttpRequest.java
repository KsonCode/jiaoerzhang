...
public interface HttpRequest {
    ...
    void jsonPostData(String url,HashMap<String,String> params,String body, ICallback callback);
    void jsonPostData(String url,String body,HashMap<String,String> params, ICallback callback);
